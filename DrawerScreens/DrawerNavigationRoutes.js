...
import EmployeeNavigationDrawerHeader from '../Components/EmployeeNavigationDrawerHeader';
import Tables from './Tables';
import Transaction from './Transaction';
import AddUpdatePage from '../DrawerScreens/AddUpdatePage';
import AddUpdateOrder from '../DrawerScreens/AddUpdateOrder';
...
import BackNavigationDrawer from '../Components/BackNavigationDrawer';
...
const orderDetailScreenStack = ({navigation}) => {
  return (
    <Stack.Navigator
      ...
      screenOptions={{
        headerLeft: () => (          
          <BackNavigationDrawer navigationProps={navigation} />          
        ),
        headerStyle: {
          backgroundColor: '#DB3133', //Set Header color
        },
...
const AddUpdateOrderStack = ({navigation}) => {
  return (
    <Stack.Navigator
      initialRouteName="AddUpdateOrder"
      screenOptions={{
        headerLeft: () => (
          <OrderNavigationDrawer navigationProps={navigation} />
        ),
...
const OrderDescriptionStack = ({navigation}) => {
  return (
    <Stack.Navigator
      initialRouteName="OrderDescriptionPage"
      screenOptions={{
        headerLeft: () => (
          <BackNavigationDrawer navigationProps={navigation} />
        ),
...
const AddEmployeeStack = ({navigation}) => {
  return (
    <Stack.Navigator
      ...
      screenOptions={{
        headerLeft: () => (
          <EmployeeNavigationDrawerHeader navigationProps={navigation} />
        ),
        headerStyle: {
          backgroundColor: '#DB3133', //Set Header color
        },
...
const DrawerNavigatorRoutes = (props) => {
  console.log('params routes', props.route.params?.operation);
  return (
    <Drawer.Navigator
...
<Drawer.Screen
    ...
    <Drawer.Screen
      ...
      <Drawer.Screen
      name="AddUpdateOrderStack"
      options={{drawerLabel:()=>null}}
      component={AddUpdateOrderStack}/>
