...
import { Int, StyleSheet, Alert, View, Button, Picker,Text,TextInput,TouchableOpacity,Modal} from 'react-native';
...
addOrder =()=>{
  ...
  console.log("Operation category *", this.oper)
  if(this.oper === "add")
  {
      console.log("Add Operation")
      var userID = this.state.userId;
      userID = userID.replace(/\"/g, '');
      // var userIdInt1 = Number(str1);
      // console.log('jj add', userIdInt1)

      console.log('AddMenuType dd'+ userID)
      
      var url = 'http://testweb.izaap.in/moop/api/index.php/service/categories/add?X-API-KEY=MoopApp2021@!';
          var dataSubmit = {            
            user_id:userID,
            rest_id:3,
  ...
  else
  {
    ...
    var str = this.state.userId;
var userIdInt = Number(str);
