...
export default class OrderDetailPage extends Component{
  ...
  //     this.orderId = this.props.route.params?.data.id;
  ...
  componentDidMount(){
    console.log('1121',this.props.route.params?.data.operation)
    this.props.navigation.addListener('focus', () => {      
     
      this.orderId = props.route.params?.data.id;
      console.log(props.route.params?.data.operation)
      console.log("componentDidMount OrderId OrderDetailPage", props.route.params?.data.id)
      console.log("componentDidMount", this.oper) 
    });  
    //this.displayData();
