  ...
  const [listData, setListData] = useState([]);
    ...
    useEffect(() => {       
      ...
      const unsubscribe = navigation.addListener('focus', () => {
        //http://testweb.izaap.in/moop/api/index.php/service/employee/lists?X-API-KEY=MoopApp2021@!&role_id=1
        fetch('http://testweb.izaap.in/moop/api/index.php/service/employee/lists?X-API-KEY=MoopApp2021@!',{
          method: 'GET'
          //Request Type 
          })
      ...
      const newData = listData.filter(
        function (item) {
          const itemData = item.title
            ...
            const itemData1 = item.first_name
            ? item.first_name.toUpperCase()
            : ''.toUpperCase();
  
            const itemData2 = item.last_name
            ? item.last_name.toUpperCase()
            : ''.toUpperCase();

            const itemData3 = item.roles_id
            ? item.roles_id.toUpperCase()
            : ''.toUpperCase();
