                ...
                {/*Content under the header of the Expandable List Item*/}
                {
                    ...
                    item.val === 'Employees' ? 
                     ...
                     <TouchableOpacity
                      key={key}
                      style={styles.content}
                      onPress={() => context.props.navObj.navigate('RolesStack',{Screen:'Roles'})}>
                      <Text style={styles.text}>
                         {item.val}
                      </Text>
                      <View style={styles.separator} />
                   ...
                   <TouchableOpacity
                      key={key}
                      style={styles.content}
                      onPress={() => context.props.navObj.navigate('PermissionsStack',{Screen:'Permissions'})}>
                      <Text style={styles.text}>
                         {item.val}
                      </Text>
                      <View style={styles.separator} />
...
export default class ExpandableViewSeparate extends React.Component {
    ...
    render() {
      let str = new String(this.state.firstName); 
      return (
        ...
        <View style={{flexDirection: 'row', width: '100%'}}>
              ...
              <Text style={styles.topHeading}>Pre Se Business</Text>  
        </View>
          ...
          <TouchableOpacity onPress={() => this.props.navObj.navigate('ProfilePageStack',{Screen:'ProfilePage'})}>
            <View style={styles.profileHeader}>
                  ...
                  <Text style={styles.profileHeaderText}>{this.state.firstName}{this.state.lastName}</Text>
  ...
  const CONTENT = [
    ...
    },
    {
      ...
      subcategory: [{ id: 1, val: 'Employees' }, { id: 2, val: 'Items' }, { id: 3, val: 'Discounts' }, { id: 4, val: 'Taxes' }],
    },
    {
      isExpanded: false,
      category_name: 'Employee',
      subcategory: [{ id: 1, val: 'Employees' }, { id: 2, val: 'Roles' }, { id: 3, val: 'Permissions' }],
    },
    {
      isExpanded: false,
